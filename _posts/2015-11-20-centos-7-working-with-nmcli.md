...
```bash
$ nmcli c m <interface_name> ipv4.method manual ipv4.addr "192.168.1.2/24" ipv4.dns "8.8.8.8,8.8.4.4" ipv4.gateway "192.168.1.2" connection.autoconnect "yes" 
```

## Konfigurasi DHCP IP Address

```bash
$ nmcli c m <interface_name> ipv4.method auto connection.autoconnect "yes"
```
